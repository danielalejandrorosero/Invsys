...
class EditarUsuarioController {
    ...
    public function editarUsuario() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['actualizarUsuario'])) {
            ...
            if ($this->usuarioModel->nombreUsuarioExiste($nombreUsuario, $id_usuario)) {
                $_SESSION['error_nombreUsuario'] = "El nombre de usuario ya existe.";
                header("Location: ../../Views/usuarios/editarUsuarioVista.php");
                exit();
            }

            // Llamar a la db
            $resultado = $this->usuarioModel->editarUsuario($id_usuario, $nombre, $nombreUsuario, $id_usuario_sesion, $nivel_sesion);
            ...
            require_once __DIR__ . '/../../Views/usuarios/editarUsuarioVista.php';
        }
    }
}
